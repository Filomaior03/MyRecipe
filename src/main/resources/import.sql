...
-- RICETTE
INSERT INTO ricetta (id, nome, categoria, tempo_di_preparazione, provenienza, procedimento) VALUES (1, 'Carbonara', 'Primo', '20 minuti', 'Italia', 'Inizia cuocendo la pasta in abbondante acqua salata. Nel frattempo, taglia il guanciale a cubetti e fallo rosolare in una padella fino a che non diventa croccante. In una ciotola, sbatti le uova con il pecorino e il parmigiano, aggiungendo un po’ di sale e pepe a piacere. Quando la pasta è pronta, scolala e mescolala con il guanciale. Aggiungi il composto di uova e formaggio, mescolando velocemente per creare una crema liscia. Servi subito con una spolverata di pepe.');
INSERT INTO ricetta (id, nome, categoria, tempo_di_preparazione, provenienza, procedimento) VALUES (2, 'Amatriciana', 'Primo', '20 minuti', 'Italia', 'Cuoci la pasta in acqua salata. Nel frattempo, taglia il guanciale a fette e rosolalo in una padella fino a che non diventa croccante. Aggiungi i pomodori pelati schiacciati e lascia cuocere per qualche minuto, aggiungendo un po’ di sale e pepe a piacere. Quando la pasta è pronta, scolala e uniscila al sugo, mescolando bene. Servi con una generosa spolverata di pecorino.');
INSERT INTO ricetta (id, nome, categoria, tempo_di_preparazione, provenienza, procedimento) VALUES (3, 'Cacio e pepe', 'Primo', '20 minuti', 'Italia', 'Cuoci la pasta in acqua salata. In una padella, tostare il pepe fino a renderlo aromatico. Scola la pasta al dente, conservando un po’ dell’acqua di cottura. Nella padella con il pepe, aggiungi un po’ di acqua di cottura della pasta e mescola bene. Unisci il pecorino grattugiato e mescola fino a ottenere una crema liscia. Aggiungi la pasta e amalgama bene, utilizzando l’acqua di cottura per regolare la consistenza. Servi subito, con una spolverata di pecorino.');
INSERT INTO ricetta (id, nome, categoria, tempo_di_preparazione, provenienza, procedimento) VALUES (4, 'Gricia', 'Primo', '20 minuti', 'Italia', 'Cuoci la pasta in acqua salata. Nel frattempo, taglia il guanciale a cubetti e fallo rosolare in una padella fino a che non diventa croccante. Scola la pasta al dente e uniscila al guanciale, mescolando bene. Aggiungi il pecorino e il parmigiano grattugiati, mescolando fino a ottenere una crema liscia, utilizzando un po’ dell’acqua di cottura della pasta per ottenere la giusta consistenza. Aggiungi un po’ di sale e pepe a piacere, e servi subito con una spolverata di pecorino.');
INSERT INTO ricetta (id, nome, categoria, tempo_di_preparazione, provenienza, procedimento) VALUES (5, 'Pollo alle mandorle', 'Secondo', '20 minuti', 'Cina', 'Taglia il petto di pollo a pezzetti e infarinali leggermente. Scalda un po’ di olio in una padella e rosola il pollo infarinato fino a che non diventa dorato. Unisci le mandorle pelate e lascia che si tostino leggermente. Aggiungi la salsa di soia e la salsa teriyaki, mescolando bene. Lascia cuocere ancora qualche minuto per far amalgamare i sapori. Servi il pollo caldo con riso o verdure a piacere.');
INSERT INTO ricetta (id, nome, categoria, tempo_di_preparazione, provenienza, procedimento) VALUES (6, 'Ravioli al vapore', 'Secondo', '20 minuti', 'Cina', 'Prepara la pasta per i ravioli usando la farina e l’acqua, impastando fino a ottenere un composto omogeneo. Stendi la pasta e crea dei dischi. In una ciotola, mescola la carne macinata con un po’ di salsa di soia e salsa teriyaki per condire il ripieno. Fai dei piccoli fagottini con la pasta, mettendo il ripieno al centro. Cuoci i ravioli al vapore fino a che non sono morbidi e pronti da servire.');
